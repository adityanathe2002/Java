...
class Child extends Parent
{
	...
	public void checkBalance()
    {
    	...
    	if(userPin==Child.obj1.getUpiPin())
    	{
    		System.out.println("Your Account Balance is - "+ Child.obj1.getBalance() + "rs");
    	}
    	else
    	{
    ...
    public void depositAmount()
    {
		...
		if(userPin==Child.obj1.getUpiPin())
		{
		   obj1.setBalance(amount +Child.obj1.getBalance());
    ...
    public void withdrawAmount()
    {
		...
		int userPin=sc.nextInt();
		if(userPin==Child.obj1.getUpiPin())
		if (withdrawAmount<=Child.obj1.getBalance())
		{
			System.out.println("Amount Withdrawn Succesfully");
			Child.obj1.setBalance(Child.obj1.getBalance()-withdrawAmount);
	    }
	    else
	    {
    ...
    public void updatedName()
    {
		...
		Child.obj1.setAccountHolderName(updatedName);
    ...
    public void updateAddress()
    {
		...
		Child.obj1.setAddress(updatedAddress);
    ...
    public void updateUpiPin()
    {
		...
		Child.obj1.setUpiPin(updatedPin);
    ...
    public void updatePhoneNumber()
    {
		...
		Child.obj1.setPhoneNumber(updatedNumber);
